	...
	return Backbone.Marionette.Layout.extend({
	    ...
	    onClose: function(){
	 	...
	 	displayLoginForm: function(){
	 		this.loading.close();
	 		this.header.show(new LoginHeader({collection: this.collection}));
